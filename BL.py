import argparse, logging, random, socket, ssl, sys, time
parser = argparse.ArgumentParser(description='Blackloris, low bandwidth stress test tool for websites')
...
user_agents = [
 ...
 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.79 Safari/537.36 Edge/14.14393Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36',
