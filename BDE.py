...
def usage():
    print '\x1b[36m AUTHOR CODING : MISTER BLACK CYBER '
    print '\x1b[34m SCRIPT : BIG BLACK DARK EVILS '
    print '\x1b[36m SCRIPT TYPE : ATTACKING'
    print '\x1b[34m TEAM : BLACK CYBER ANONYMOUS TEAM 2K07 '
    print '\x1b[36m TEAM SUPPORT : MARIANAS WEB TEAM 2K05'
    print '\x1b[34m VERSION : 8.8.8'
    print '\x1b[36m SCIRPT COLLAB : BLACK CYBER x DARKNET RUDY x CAPTAIN ANON'
...
def httpcall(url):
    ...
    try:
        ...
        set_flag(1)
        print '\x1b[31m ATTACKING WEBSITE'
        code = 500
...
class MonitorThread(threading.Thread):
    ...
    def run(self):
        ...
        if flag == 2:
            print '\n-- Sending Massive Packets Of Fear By Black Cyber Marianas Botnet --'
...
if len(sys.argv) < 2:
    ...
    print '\x1b[35mBIG DARK EVILS DDOS '
    print '\x1b[35mCREATED BY BLACK CYBER ANONYMOUS'
    print '\x1b[31mSEDANG ATTACKING SERVER... '
    if len(sys.argv) == 3:
        if sys.argv[2] == 'safe':
            set_safe()
    url = sys.argv[1]
